...
$edit_stu_data = "SELECT * FROM `$instit"."_students` WHERE `rollnumber` = '$editroute';";
$edit_stu_data_req = mysqli_query($conn, $edit_stu_data);
$edit_data_array = mysqli_fetch_assoc($edit_stu_data_req);



//Receiving data
if (isset($_POST['submission_data']) && isset($_POST['submit'])) {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="upload-btn-wrapper">
                                                <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="text" value="<?php echo $edit_data_array['rollnumber'] ?>" id="stu-roll" placeholder="" name="sturoll" required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mx-lg-auto  col-xl-5 col-lg-6 col-sm-12 row">
                            <div class="card card-stats mb-4 mb-xl-0 col-12">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <img width="100%" id="preview-pic" style="object-fit: contain;" src="/data/students/<?php echo $instit?>/<?php echo $edit_data_array['rollnumber'] ?>/<?php echo $edit_data_array['photo_name'] ?>"  alt="profile picture" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info ">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="text" value="<?php echo $edit_data_array['student_name'] ?>" id="stu-name" placeholder="Ashwin Ravi S" name="stuname" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0  col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="text" value="<?php echo $edit_data_array['father_name'] ?>" id="stu-fa-name" placeholder="Sampath Kumar" name="stufathername" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="text" value="<?php echo $edit_data_array['mother_name'] ?>" id="stu-ma-name" placeholder="Preethi Ravi" name="stumomname" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" class="form-control rounded-25" id="stu-bld-grp" name="stufathername" required>
                                                <option><?php echo $edit_data_array['blood_group'] ?></option>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="date" value="<?php echo $edit_data_array['dob'] ?>" id="stu-dob" placeholder="01/01/2001" name="studob" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 row">
                                            <div class="col-lg-1 col-sm-2 form-check my-auto" style="width: 30px;">
                                                <input class="form-check-input rounded-25" style="width: 30px; height: 30px;border: 1px solid rgba(50, 50, 50, 1);" type="checkbox" value="<?php echo $edit_data_array['pwd'] ?>" id="stu-pwd" name="stu-pwd" onclick="pwdchecker()" onchange="pwdchecker()" onforminput="pwdchecker()" />
                                                <script>
                                            ...
                                            <div class="col-lg-10 col-sm-10 ms-3">
                                                <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="text" value="<?php echo $edit_data_array['pwd_issue'] ?>" id="stu-pwd-issue" placeholder="Type Your Issue" name="stupwdissue" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="text" value="<?php echo $edit_data_array['id_mark_1'] ?>" id="stu-id-mark-1" placeholder="Identification 1" name="stuidmark1" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="text" value="<?php echo $edit_data_array['id_mark_2'] ?>" id="stu-id-mark-2" placeholder="Identification 2" name="stuidmark2" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <select style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" class="form-control rounded-25" id="stu-gen" name="stu-gen" required>
                                                <option><?php echo $edit_data_array['gender'] ?></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <select style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" class="form-control rounded-25" id="stu-class" name="stu-class" required>
                                                <option> <?php echo $edit_data_array['class'] ?></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <select style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" class="form-control rounded-25" id="stu-edu-grp" name="stu-edu-grp" required>
                                                <option><?php echo $edit_data_array['edu_group'] ?></option>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="text" value="<?php echo $edit_data_array['acad_year'] ?>" id="stu-aca-year" placeholder="2022-2023" name="stuacayear" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="text" value="<?php echo $edit_data_array['stu_pass'] ?>" id="stu-pass" placeholder="Type the Password" name="stupass" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="tel" value="<?php echo $edit_data_array['contact_1'] ?>" id="stu-cont-1" placeholder="9876543210" name="stucontnum1" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px;" type="tel" value="<?php echo $edit_data_array['contact_2'] ?>" id="stu-cont-2" placeholder="9753186420" name="stucontnum2" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0 col-12 border-5 border-top-0 border-start-0 border-end-0 border-bottom border-info">
                                <div class="card-body d-flex align-items-center">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <textarea class="form-control rounded-25" style="border: 1px solid rgba(50, 50, 50, 1); padding: 10px; resize: none;" type="text" value="<?php echo $edit_data_array['id_mark_2'] ?>" id="stu-addr" placeholder="Type your Address here" name="stuaddress" rows="4" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
